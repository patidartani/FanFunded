        ...
        <div className="challange-btm">
             ...
             <div className="border-left-right"></div> 
                   ...
                   <div className="full-challenge">
                    <h5 style={{fontSize:"1.8vmax"}}>Blitz</h5>
                    ...
                    <p style={{marginTop:"1vmax"}}>Prove your skills in 48 hours to unlock the blitz challenge. Win a funded account and earn up to 80% rewards. </p>
